...
// Portail public (sans compte) réservé au client : il consulte sa situation en
// saisissant son immatriculation. L'espace fournisseur, lui, est un compte créé
// par le super-admin (voir routes/espaceFournisseur.js).
const r = Router();
