...
import { requireAuth, denySuperadmin, denyFournisseur, requireEspaceActif, requireRole, requireAbonnementActif } from '../lib/auth.js';
...
r.use(requireAuth, denySuperadmin, denyFournisseur, requireEspaceActif, requireAbonnementActif);
